...
install_xcframework "${PODS_ROOT}/PayUIndia-NativeOtpAssist/framework/PayUNativeOtpAssist.xcframework" "PayUNativeOtpAssist" "framework" "ios-arm64" "ios-x86_64-simulator"
