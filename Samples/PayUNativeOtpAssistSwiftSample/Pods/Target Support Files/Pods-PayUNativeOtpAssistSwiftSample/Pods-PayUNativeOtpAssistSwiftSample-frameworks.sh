...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  install_framework "${PODS_XCFRAMEWORKS_BUILD_DIR}/PayUAnalytics/PayUAnalytics.framework"
  ...
  install_framework "${PODS_XCFRAMEWORKS_BUILD_DIR}/PayUNativeOtpAssist/PayUNativeOtpAssist.framework"
