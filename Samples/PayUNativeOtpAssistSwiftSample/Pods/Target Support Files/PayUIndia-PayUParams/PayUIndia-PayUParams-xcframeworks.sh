...
install_xcframework "${PODS_ROOT}/PayUIndia-PayUParams/PayUParamsKit/PayUParamsKit.xcframework" "PayUParamsKit" "framework" "ios-armv7_arm64" "ios-x86_64_i386-simulator"
